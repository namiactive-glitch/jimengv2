      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
          <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center border border-red-100">
            ...
            <h2 className="text-xl font-medium text-orange-900 mb-2">Đã xảy ra lỗi hệ thống</h2>
            <p className="text-slate-600 mb-6 text-sm">
              Ứng dụng gặp sự cố không mong muốn. Dữ liệu của bạn đã được lưu tự động.
            </p>
            <button 
              onClick={this.handleReset} 
              className="w-full py-3 bg-orange-600 hover:bg-orange-700 text-orange-600 font-medium rounded-xl transition-all shadow-lg active:scale-95"
            >
